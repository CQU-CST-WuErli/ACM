...
int judge(Line& a,Line& b) {
	double dx1=a.dx(),dy1=a.dy();
	double dx2=b.dx(),dy2=b.dy();
	if (dy1*dx2==dx1*dy2) {
		double dx3=a.s.x-b.s.x;
		double dy3=a.s.y-b.s.y;
		if (dx3*dy1==dy3*dx1) return 1;
		else return 2;
	}
	return 3;
}
...
int main(int argc, char const *argv[]) {
    ...
    while(t--) {
    	...
    	int tt=judge(a,b);
    	if (tt==1) puts("LINE");
    	else if (tt==2) puts("NONE");
    	else {
    		Point tmp=GetLineIntersection(a.s,a.t-a.s,b.s,b.t-b.s);
