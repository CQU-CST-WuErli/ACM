...
const int N=2e5;
int pnt[N],nxt[N],head[N],w[N],pre[N],f[N];
int n,m;
int cnt;

void add_edge(int u,int v,int c){
	pnt[cnt]=v;pre[cnt]=u;nxt[cnt]=head[u];head[u]=cnt;f[cnt]=1;
	w[cnt++]=c;
}

int del;
int tt;
int vis[1500],dp[1500];
int p[1500];
